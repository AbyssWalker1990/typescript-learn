...
function Autobind (_: any, _2: string, descriptor: PropertyDescriptor): PropertyDescriptor {
  const origonalMethod = descriptor.value
  const adjDescriptor: PropertyDescriptor = {
    configurable: true,
    enumerable: false,
    get () {
      const boundFn = origonalMethod.bind(this)
      return boundFn
    }
  }
...
type ValidatorConfig = Record<string, Record<string, string[]>>

const registeredValidators: ValidatorConfig = {}

function Required (target: any, propName: string): void {
